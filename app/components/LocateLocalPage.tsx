            ...
            >
              <Box mb={{ base: 8, md: 20 }}>
                ...
                <Text fontSize={"lg"} color={"white"}>
                  A business directory allowing users to find busiensses and
      ...
      <Box position={"relative"}>
        <Container maxW={"4xl"} p="12">
          ...
          <Text as="p" marginTop="5">
            ...
            encouragement to support local businesses. However, I often found it
            difficult to identify businesses that operate in the local area,
            especially those business who are based online.
            <br />
            <br></br>
            When searching for local businesses I frequently encountered a few
            issues:
            <UnorderedList>
              <ListItem>
          ...
          business local to my area promote their products and services. This
          included business directories, local community webpages and local
          social media groups.
          <br />
          <br></br>
          When reviewing these online platforms my aim was to explore how easily
          and efficiently I could find particular business. I gave myself a
          number of services and products to search for locally. I used the
          below questions to guide this research:
          <br />
          <br></br>
